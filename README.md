...
```bash
scoop bucket add terraform-docs https://nholuongut/terraform-docs/scoop-bucket
...
```bash
curl -Lo ./terraform-docs.tar.gz https://nholuongut/terraform-docs/terraform-docs/releases/download/v0.19.0/terraform-docs-v0.19.0-$(uname)-amd64.tar.gz
...
```bash
# go1.17+
go install nholuongut/terraform-docs/terraform-docs@v0.19.0
```

```bash
# go1.16
GO111MODULE="on" go get nholuongut/terraform-docs/terraform-docs@v0.19.0
```
...
```bash
$(go env GOPATH)/src/nholuongut/terraform-docs/terraform-docs/bin/$(uname | tr '[:upper:]' '[:lower:]')-amd64/terraform-docs
```
...
```yaml
repos:
  - repo: https://nholuongut/terraform-docs/terraform-docs
    rev: "v0.19.0"
    hooks:
...
```go
import (
    "nholuongut/terraform-docs/terraform-docs/format"
    "nholuongut/terraform-docs/terraform-docs/print"
    "nholuongut/terraform-docs/terraform-docs/terraform"
)
...
import (
    ...
    "nholuongut/terraform-docs/terraform-docs/plugin"
    "nholuongut/terraform-docs/terraform-docs/print"
    "nholuongut/terraform-docs/terraform-docs/template"
    "nholuongut/terraform-docs/terraform-docs/terraform"
)
