...
import (
	...
	"nholuongut/terraform-docs/terraform-docs/cmd/completion/bash"
	"nholuongut/terraform-docs/terraform-docs/cmd/completion/fish"
	"nholuongut/terraform-docs/terraform-docs/cmd/completion/zsh"
)
